# Rich-E-Commerce-Frontend

Rich-E-Commerce-Frontend is the frontend of an e-commerce web application built with ReactJS ,Material UI, ContextAPI, React-router-dom
...
The backend of the application is built with NodeJS and ExpressJS and uses a MongoDB database to store the product and user data. The source code for the backend can be found at [https://github.com/SoftwareEngineer-node/Rich-E-Commerce-Backend](https://github.com/SoftwareEngineer-node/Rich-E-Commerce-Backend).
...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/SoftwareEngineer-node/Rich-E-Commerce-Frontend.git
   ```

2. Install the dependencies:

   ```
   cd Rich-E-Commerce-Frontend
   npm install
   ```
